...
import { COLUMNS_CATEGORY,COLUMNS_TEAMS } from "../utils/Col.js";
...
export default function Team({ setName }) {
  ...
  //     toast("Departments loading, please wait...", {
  //       progress: true,
  //     });
  ...
  const fetchdata = async () => {
    toast("Team Members loading please wait", {
      progress: true,
    });
  ...
  const columns = useMemo(() => COLUMNS_TEAMS, []);
      ...
      <div className="content">
        <div className="add-link">
          <div className="">
            ...
            >
              ...
              />
              <span className="med-font">Add new Team Member</span>
            </NavLink>
          </div>
        </div>
        <div className="categories-data">
          <div className="categories">
            <div>
              <span className="bigger-font">Team Members</span>
            </div>
          ...
          <div className="table">
            <table {...getTableProps()}>
              ...
              <tbody {...getTableBodyProps()}>
                {page.length === 0 ? (
                  <tr>
                    <td colSpan={columns.length}>No Team Member found</td>
                  </tr>
                ) : (
                  page.map((row) => {
                    prepareRow(row);
