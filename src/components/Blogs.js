...
import { COLUMNS_TEAMS,COLUMNS_Blogs } from "../utils/Col.js";
...
export default function Blogs({ setName }) {
  ...
  const fetchdata = async () => {
    toast("blogs loading please wait", {
      progress: true,
    });
  ...
  const columns = useMemo(() => COLUMNS_Blogs, []);
      ...
      <div className="content">
        <div className="add-link">
          <div className="">
            ...
            >
              ...
              />
              <span className="med-font">Add new Blog</span>
            </NavLink>
          </div>
        </div>
        <div className="categories-data">
          <div className="categories">
            <div>
              <span className="bigger-font">Blogs</span>
            </div>
